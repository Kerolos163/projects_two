      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: Icon(Icons.shopping_cart, color: Color(0xff323232)),
          ),
        ],
      ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 40),
                ReviewSection(rating: double.parse(widget.product.ratingsAverage)),
                RatingBarWidget(
                  initialRating: double.parse(widget.product.ratingsAverage),
                ),
                Text(
